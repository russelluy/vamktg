  ...
  [#assign first="false"]
    <thead>
      <tr>
        ...
        <th class="col fourth">[#if column.hasProperty('four')][@macros.createAnchor column.getProperty('four').string!/][/#if]</th>
      </tr>
    </thead>
    <tbody>
  [#else]
    <tr>
      ...
      <td class="col fourth">[#if column.hasProperty('four')][@macros.createAnchor column.getProperty('four').string!/][/#if]</td>
    </tr>
  [/#if]
[/#list]
[/#if]
